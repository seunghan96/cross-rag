...
def data_provider(args, flag, drop_last_test=False, train_all=False, retriever_rawdata=None):
    ...
    if 'retrieve' in args.model_id:
        # Get output_norm and output_norm_mode from args (default to False and 'y' if not provided)
        output_norm = getattr(args, 'output_norm', False)
        output_norm_mode = getattr(args, 'output_norm_mode', 'y')
        ...
        data_set = Data(
            ...
            output_norm_mode=output_norm_mode
        )
