#!/bin/bash
# -*- coding: utf-8 -*-
# Total experiment script (TabPFN dualhead_R_as_key transfer variant): Pretrain + Zero-shot Transfer Learning for all combinations
...
if [ "$pretrain_skipped" = true ]; then
    ...
    continue
                            ...
                            filename_base="zeroshot_transfer_${backbone}_lb${lookback_length}_${similarity_space}_k${top_k}_TabPFN_dualhead_R_as_key_l${dual_lambda}"
                            ...
                            for kb_dataset in "${all_datasets[@]}"; do
                                for target_dataset in "${all_datasets[@]}"; do
                                    echo ""
                                    ...
                                    model_id_zeroshot="${target_dataset}_zeroshot_transfer_kb${kb_dataset}_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_${retrieve_suffix}${output_norm_suffix}_TabPFN_dualhead_R_as_key_l${dual_lambda}"
