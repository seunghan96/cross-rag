#!/bin/bash
# -*- coding: utf-8 -*-
# Total experiment script (TabPFN dualhead_learnable variant, customizable horizons): Pretrain + Zero-shot for all combinations
...
export CHRONOS_TABPFN_VARIANT=dualhead_learnable_custom
...
similarity_spaces=("X-cosine-norm" "X-cosine" "X-euclidean" "X-euclidean-norm")
top_ks=(1)
backbones=("Chronos")
output_norms=(false)
output_norm_modes=("x")
