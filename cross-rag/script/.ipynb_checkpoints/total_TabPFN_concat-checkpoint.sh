#!/bin/bash
# -*- coding: utf-8 -*-
# Total experiment script (TabPFN concat variant): Pretrain + Zero-shot for all combinations
...
export CHRONOS_TABPFN_VARIANT=concat
            ...
            for backbone in "${backbones[@]}"; do
                for output_norm in "${output_norms[@]}"; do
                    for output_norm_mode in "${output_norm_modes[@]}"; do
                        ...
                        model_id_pretrain="pretrain_${backbone}_lb${lookback_length}_${similarity_space}_k${top_k}${output_norm_suffix}_TabPFN_concat"
                        ...
                        filename_base="zeroshot_${backbone}_lb${lookback_length}_${similarity_space}_k${top_k}_TabPFN_concat"
