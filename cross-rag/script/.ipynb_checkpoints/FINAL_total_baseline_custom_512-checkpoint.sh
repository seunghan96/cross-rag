...
export CHRONOS_TABPFN=0
export CHRONOS_TABPFN_VARIANT=custom
...
#forecast_horizons=(${FORECAST_HORIZONS:-16 24 32 48 64})
#forecast_horizons=(${FORECAST_HORIZONS:-48 64})
forecast_horizons=(${FORECAST_HORIZONS:-36})
...
total_combinations=$((${#input_horizons[@]} * ${#forecast_horizons[@]} * ${#lookback_lengths[@]} * ${#similarity_spaces[@]} * ${#top_ks[@]} * ${#backbones[@]} * ${#output_norms[@]} * ${#output_norm_modes[@]}))
